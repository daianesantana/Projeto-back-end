...
async function mostraMulheres(request, response){
    try{
        const mulheresVindasDoBancodeDados = await Mulher.find()// esperando a conexão e buscando a lista de muleres
...
app.use(router.delete('/mulheres/:id', deletaMulher))//cofiguração rota delete
